/**
 * see: http://answers.unity3d.com/questions/11022/how-to-rotate-gui-textures.html
 */
using UnityEngine;
...
//this will overwrite the items position
	...
	void UpdateSettings ()
	{
		...
		case AlignmentScreenpoint.LeftMiddle:
			...
			break;
		case AlignmentScreenpoint.Centre:
			cornerPos = new Vector2 (Screen.width / 2, Screen.height / 2);
			break;
